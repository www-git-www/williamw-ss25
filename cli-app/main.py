...
count_help="Calculate to this many places. IE: 0,1,1,2,3,5 would be the result of -c 6"
...
numbering_help="Preface each number in the sequence with it's placement. IE for \"-c 6 --numbering --one-line\" you would get this: \" 1:0, 2:1, 3:1, 4:2, 5:3, 6:5\" where the first number is the count and the second is the Fibonacci sequence."
